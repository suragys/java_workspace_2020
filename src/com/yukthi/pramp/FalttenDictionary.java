...
class FalttenDictionary {

    static HashMap<String, String> flattenDictionary(HashMap<String, Object> dict) {
        //  dict : { 'key1' => { '' => { 'a' => } }, '' => '' }
        Map<String, String> res = new HashMap<>();

        for (Entry<String, Object> e : dict.entrySet()) {     // 'key1' , '1'   //'key2' =?> {..}
            String key = e.getKey(); // key2
            Object value = e.getValue();
            if(value instanceof String) {
               res.put(key,value.toString());
            } else {
                Map<String, String> subMap = flattenDictionary((HashMap<String, Object>) value);
